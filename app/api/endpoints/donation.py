...
DONATIONS = "Список пожертвований"
CREATE_DONATION = "Создать пожертвование"
USERS_DONATION = "Список пожертвований пользователя"
...
async def create_donation(
    ...
    not_fully_funded_projects = await (
        charity_project_crud.get_not_closed(session)
    )
    session.add_all(
        allocate_donations(
